...
- сопоставь расход с одной из существующих категорий, если она подходит по смыслу
- Если ВСЕ существующие категории плохо подходят — создай новую осмысленную категорию
- Не пытайся пытайся использовать категории, которые не подходят по смыслу под расход
...
Ввод: "Обед 60 лари"
Вывод: [{"amount": 60.0, "currency": "GEL", "category": "Еда", "description": "обед"}]
